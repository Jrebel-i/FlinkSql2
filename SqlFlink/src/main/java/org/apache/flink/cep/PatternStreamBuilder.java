...
final class PatternStreamBuilder<IN> {
    ...
    static <IN> PatternStreamBuilder<IN> forStreamAndPattern(
        ...
        return new PatternStreamBuilder<>(
                inputStream, pattern,
                inputStream.getExecutionEnvironment().getStreamTimeCharacteristic()== TimeCharacteristic.ProcessingTime ? TimeBehaviour.ProcessingTime:TimeBehaviour.EventTime,
                null, null);
    }
}
