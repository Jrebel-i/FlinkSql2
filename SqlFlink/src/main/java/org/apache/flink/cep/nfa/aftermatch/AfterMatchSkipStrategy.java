...
public abstract class AfterMatchSkipStrategy implements Serializable {
    ...
    public void prune(
            ...
            Collection<Map<String, List<org.apache.flink.cep.nfa.sharedbuffer.EventId>>> matchedResult,
            SharedBufferAccessor<?> sharedBufferAccessor)
            throws Exception {

        org.apache.flink.cep.nfa.sharedbuffer.EventId pruningId = getPruningId(matchedResult);
        if (pruningId != null) {
     ...
     */
    protected abstract boolean shouldPrune(org.apache.flink.cep.nfa.sharedbuffer.EventId startEventID, org.apache.flink.cep.nfa.sharedbuffer.EventId pruningId);
     ...
     */
    protected abstract org.apache.flink.cep.nfa.sharedbuffer.EventId getPruningId(Collection<Map<String, List<org.apache.flink.cep.nfa.sharedbuffer.EventId>>> match);
    ...
    static org.apache.flink.cep.nfa.sharedbuffer.EventId max(org.apache.flink.cep.nfa.sharedbuffer.EventId o1, org.apache.flink.cep.nfa.sharedbuffer.EventId o2) {
        if (o2 == null) {
            return o1;
        }
    ...
    static org.apache.flink.cep.nfa.sharedbuffer.EventId min(org.apache.flink.cep.nfa.sharedbuffer.EventId o1, EventId o2) {
        if (o2 == null) {
            return o1;
        }
