 ...
 *
 * @param <T> type of events that are handled by the {@link org.apache.flink.cep.pattern.conditions.IterativeCondition}
 */
public class StateTransition<T> implements Serializable {
    ...
    private org.apache.flink.cep.pattern.conditions.IterativeCondition<T> condition;
    ...
    public org.apache.flink.cep.pattern.conditions.IterativeCondition<T> getCondition() {
        return condition;
    }
