...
import com.hc.cep_module.cep2.CepListener;
 ...
 * defined by the {@link Pattern} specifying the sought-after pattern.
...
public abstract class PatternProcessFunction<IN, OUT> extends AbstractRichFunction {
    ...
    private CepListener cepListener = null;
    /**
    ...
    public void registerListener(CepListener<IN> cepListener) {
        this.cepListener=cepListener;
        this.flagNeedListern=true;
    }
    public Boolean getFlagNeedListern() {
        return flagNeedListern;
    }
    public void cepListenerInit(){
        cepListener.init();
    }
    public Pattern getNewPattern(IN flagElement) throws Exception {
        return cepListener.returnPattern(flagElement);
    }
    public Boolean needChange(IN flagElement){
        return cepListener.needChange(flagElement);
    }
    /**
