...
/** Adapter that expresses {@link org.apache.flink.cep.PatternFlatSelectFunction} with {@link org.apache.flink.cep.functions.PatternProcessFunction}. */
@Internal
public class PatternFlatSelectAdapter<IN, OUT> extends PatternProcessFunction<IN, OUT> {

    private final org.apache.flink.cep.PatternFlatSelectFunction<IN, OUT> flatSelectFunction;
