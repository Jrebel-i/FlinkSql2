...
public class NFAState {
    ...
    /**
     * Current set of {@link org.apache.flink.cep.nfa.ComputationState computation states} within the state machine. These
     * are the "active" intermediate states that are waiting for new matching events to transition
     * to new valid states.
     */
    private Queue<org.apache.flink.cep.nfa.ComputationState> partialMatches;

    private Queue<org.apache.flink.cep.nfa.ComputationState> completedMatches;

    /** Flag indicating whether the matching status of the state machine has changed. */
    private boolean stateChanged;

    public static final Comparator<org.apache.flink.cep.nfa.ComputationState> COMPUTATION_STATE_COMPARATOR =
            Comparator.<org.apache.flink.cep.nfa.ComputationState>comparingLong(
                            c ->
    ...
    public NFAState(Iterable<org.apache.flink.cep.nfa.ComputationState> states) {
        this.partialMatches = new PriorityQueue<>(COMPUTATION_STATE_COMPARATOR);
        for (org.apache.flink.cep.nfa.ComputationState startingState : states) {
    ...
    public NFAState(
            Queue<org.apache.flink.cep.nfa.ComputationState> partialMatches, Queue<org.apache.flink.cep.nfa.ComputationState> completedMatches) {
    ...
    public Queue<org.apache.flink.cep.nfa.ComputationState> getPartialMatches() {
        return partialMatches;
    }

    public Queue<org.apache.flink.cep.nfa.ComputationState> getCompletedMatches() {
