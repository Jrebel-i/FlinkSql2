...
public class PatternStream<T> {
    ...
    private final org.apache.flink.cep.PatternStreamBuilder<T> builder;
    private Boolean hasListener = false;
    private CepListener cepListener = null;

    public PatternStream registerListener(CepListener cepListener){
        this.cepListener=cepListener;
        this.hasListener=true;
        return this;
    }

    private PatternStream(final org.apache.flink.cep.PatternStreamBuilder<T> builder) {
        this.builder = checkNotNull(builder);
    }

    PatternStream(final DataStream<T> inputStream, final Pattern<T, ?> pattern) {
        this(org.apache.flink.cep.PatternStreamBuilder.forStreamAndPattern(inputStream, pattern));
    }
