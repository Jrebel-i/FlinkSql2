...
class MigrationUtils {
    ...
    static <T> Queue<org.apache.flink.cep.nfa.ComputationState> deserializeComputationStates(
            SharedBuffer<T> sharedBuffer,
            TypeSerializer<T> eventSerializer,
            DataInputView source)
            throws IOException {

        Queue<org.apache.flink.cep.nfa.ComputationState> computationStates = new LinkedList<>();
