...
/** Adapter that expresses {@link org.apache.flink.cep.PatternSelectFunction} with {@link org.apache.flink.cep.functions.PatternProcessFunction}. */
@Internal
public class PatternSelectAdapter<IN, OUT> extends PatternProcessFunction<IN, OUT> {

    private final org.apache.flink.cep.PatternSelectFunction<IN, OUT> selectFunction;
