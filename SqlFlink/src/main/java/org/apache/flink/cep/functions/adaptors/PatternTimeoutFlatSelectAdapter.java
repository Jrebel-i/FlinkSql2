...
/**
 * Adapter that expresses combination of {@link org.apache.flink.cep.PatternFlatSelectFunction} and {@link
 * PatternTimeoutFlatSelectAdapter} with {@link org.apache.flink.cep.functions.PatternProcessFunction}.
 */
@Internal
public class PatternTimeoutFlatSelectAdapter<IN, OUT, T> extends PatternFlatSelectAdapter<IN, OUT>
    ...
    private final org.apache.flink.cep.PatternFlatTimeoutFunction<IN, T> flatTimeoutFunction;
    ...
    public PatternTimeoutFlatSelectAdapter(
            ...
            org.apache.flink.cep.PatternFlatTimeoutFunction<IN, T> flatTimeoutFunction,
    ...
    @Override
    public void processTimedOutMatch(Map<String, List<IN>> match, org.apache.flink.cep.functions.PatternProcessFunction.Context ctx) throws Exception {
     ...
     * expects {@link Collector} through the {@link org.apache.flink.cep.functions.PatternProcessFunction.Context} of enclosing
