...
abstract class SkipToElementStrategy extends AfterMatchSkipStrategy {
    ...
    @Override
    protected boolean shouldPrune(org.apache.flink.cep.nfa.sharedbuffer.EventId startEventID, org.apache.flink.cep.nfa.sharedbuffer.EventId pruningId) {
        return startEventID != null && startEventID.compareTo(pruningId) < 0;
    }

    @Override
    protected org.apache.flink.cep.nfa.sharedbuffer.EventId getPruningId(Collection<Map<String, List<org.apache.flink.cep.nfa.sharedbuffer.EventId>>> match) {
        org.apache.flink.cep.nfa.sharedbuffer.EventId pruningId = null;
        for (Map<String, List<org.apache.flink.cep.nfa.sharedbuffer.EventId>> resultMap : match) {
            List<org.apache.flink.cep.nfa.sharedbuffer.EventId> pruningPattern = resultMap.get(patternName);
            ...
            if (shouldThrowException) {
                org.apache.flink.cep.nfa.sharedbuffer.EventId startEvent =
