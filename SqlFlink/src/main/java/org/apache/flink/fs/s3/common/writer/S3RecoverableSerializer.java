...
@Internal
public class S3RecoverableSerializer implements SimpleVersionedSerializer<S3Recoverable> {

    public static final S3RecoverableSerializer INSTANCE = new S3RecoverableSerializer();
