...
/**
 * Adapter that expresses combination of {@link org.apache.flink.cep.PatternSelectFunction} and {@link
...
public class PatternTimeoutSelectAdapter<IN, OUT, T> extends PatternSelectAdapter<IN, OUT>
    ...
    private final org.apache.flink.cep.PatternTimeoutFunction<IN, T> timeoutFunction;
