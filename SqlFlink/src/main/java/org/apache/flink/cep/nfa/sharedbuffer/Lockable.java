...
public final class Lockable<T> {
    ...
    public static class LockableTypeSerializer<E> extends TypeSerializer<Lockable<E>>
        ...
        public TypeSerializerSnapshot<Lockable<E>> snapshotConfiguration() {
            return new org.apache.flink.cep.nfa.sharedbuffer.LockableTypeSerializerSnapshot<>(this);
        }
        ...
        public <U> TypeSerializerSnapshot<Lockable<E>> transformLegacySerializerSnapshot(
            ...
            if (legacySnapshot instanceof org.apache.flink.cep.nfa.sharedbuffer.LockableTypeSerializerSnapshot) {
            ...
            org.apache.flink.cep.nfa.sharedbuffer.LockableTypeSerializerSnapshot<E> lockableSnapshot =
